...
} from "@/components/admin-ui/mention-suggestion-list";
      ...
      <Dialog open={true} onOpenChange={(v) => !v && setShowLinkDialog(false)}>
        ...
        <DialogFooter>
          ...
          <button
            ...
            className="flex h-8 items-center rounded-md bg-primary px-3 text-sm font-medium text-white transition-colors hover:bg-primary/90"
          >
            Apply
          </button>
        </DialogFooter>
      ...
      <Dialog open={true} onOpenChange={(v) => !v && setShowImageDialog(false)}>
        ...
        <DialogFooter>
          ...
          <button
            ...
            className="flex h-8 items-center rounded-md bg-primary px-3 text-sm font-medium text-white transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Insert
          </button>
        </DialogFooter>
