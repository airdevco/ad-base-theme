    ...
    <div className="flex flex-col">
      ...
      <div className="p-3">
        ...
        <button
          ...
          onClick={onApply}
          disabled={!hasValue}
          className="mt-3 flex h-7 w-full items-center justify-center rounded-lg bg-primary text-xs font-medium text-white transition-colors hover:bg-primary-hover active:bg-primary-active disabled:cursor-not-allowed disabled:opacity-40"
        >
          Apply filter
        </button>
      </div>
